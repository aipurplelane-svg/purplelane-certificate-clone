...
const Header = () => {
  return (
    <header className="sticky top-0 z-10 flex h-[80px] w-full items-center bg-white px-8 py-[10px] font-sans">
      <div className="mx-auto flex w-full max-w-[1210px] items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            className="block rounded-[10px] bg-[#ff6d34] px-4 py-[13px] text-base font-bold text-white transition-colors hover:bg-[#ff7c48]"
          >
            Request a Call Back
          </a>
